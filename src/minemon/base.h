...
#ifndef MINEMON_BASE_H
#define MINEMON_BASE_H
...
public:
    ...
    virtual int64 GetBlockPowReward(const int nHeight) = 0;
...
public:
    ...
    virtual bool GetProofOfWorkTarget(const uint256& hashPrev, int nAlgo, uint32_t& nBits) = 0;
