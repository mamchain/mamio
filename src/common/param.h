...
#define PROOF_OF_WORK_BITS_INIT GET_PARAM(15, 25) //GET_PARAM(45, 25)
#define PROOF_OF_WORK_DIFFICULTY_INTERVAL GET_PARAM(10000, 30)
...
#define BPX_REPEAT_MINT_HEIGHT GET_PARAM(5, 1) //GET_PARAM(100, 1)
