...
#define PROOF_OF_WORK_BITS_INIT GET_PARAM(32, 20)
...
#define BPX_REPEAT_MINT_HEIGHT GET_PARAM(100, 1)               //100;
#define BPX_PLEDGE_REWARD_DISTRIBUTE_HEIGHT GET_PARAM(1440, 5) //1440;
#define BPX_REDEEM_DAY_COUNT GET_PARAM(100, 10)                //100;
#define BPX_REDEEM_DAY_HEIGHT GET_PARAM(1440, 5)               //1440;
