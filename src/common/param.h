...
static const int PROOF_OF_WORK_BITS_LOWER_LIMIT = 45;
static const int PROOF_OF_WORK_BITS_UPPER_LIMIT = 200;
#define PROOF_OF_WORK_BITS_INIT GET_PARAM(40, 25)
#define PROOF_OF_WORK_DIFFICULTY_INTERVAL GET_PARAM(2000, 30)
...
#define BPX_REPEAT_MINT_HEIGHT GET_PARAM(100, 1)
#define BPX_PLEDGE_REWARD_DISTRIBUTE_HEIGHT GET_PARAM(5, 5) //GET_PARAM(1440, 5)
#define BPX_REDEEM_DAY_COUNT GET_PARAM(100, 10)
#define BPX_REDEEM_DAY_HEIGHT GET_PARAM(1440, 5)
