...
public:
    CDestination();
    CDestination(const minemon::crypto::CPubKey& pubkey);
    ...
    CDestination& SetPubKey(const minemon::crypto::CPubKey& pubkey);
    bool GetPubKey(minemon::crypto::CPubKey& pubkey) const;
    const minemon::crypto::CPubKey GetPubKey() const;
