...
def RPCHelp_cpp(w):
    ...
    for mode in modes:
        ...
        if mode != 'EModeType::CONSOLE':
            ...
            # options is not empty, output options. It's minemon-cli -help
...
def generate_protocol_h():
    with open(protocol_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef MINEMON_RPC_AUTO_PROTOCOL_H
#define MINEMON_RPC_AUTO_PROTOCOL_H
...
#endif  // MINEMON_RPC_AUTO_PROTOCOL_H
''')
...
def generate_config_h():
    with open(config_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef MINEMON_MODE_AUTO_CONFIG_H
#define MINEMON_MODE_AUTO_CONFIG_H
...
#endif  // MINEMON_MODE_AUTO_CONFIG_H
''')
